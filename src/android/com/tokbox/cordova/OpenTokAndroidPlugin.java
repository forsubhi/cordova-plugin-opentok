...
public class OpenTokAndroidPlugin extends CordovaPlugin implements
    ...
    String publishedToken = "T1==";
    String sessionId = "1_MX40NTU5NjY0Mn5-MTQ2NDI3MzI4NjA4N356bEp1dk5ENGVoelgrajVUMHk1b1czK3B-UH4";
    String API_KEY = "45596642";
    ...
    public class RunnablePublisher extends RunnableUpdateViews implements
        ...
        public void onStreamCreated(PublisherKit arg0, Stream arg1) {
            ...
            String streamId = arg1.getStreamId();
            streamCollection.put(streamId, arg1);
    ...
    private void publishVideo(boolean publishVideo) {
    ...
    private void connect() {
        ...
        mSession.connect(publishedToken);
    }

    private void initSession(JSONArray args) throws JSONException {
        Log.i(TAG, "created new session with data: " + args.toString());
        mSession = new Session(this.cordova.getActivity().getApplicationContext(), API_KEY, sessionId);
    ...
    public void triggerStreamCreated(Stream arg1, String eventType) {
        ...
        try {
            ...
            jsonArray.put(arg1.getStreamId());
            subscribe(jsonArray);
